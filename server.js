...
// Exercise 5: Respond to connection events
  ...
  wsServer.on('connection',(socket) => {
    console.log("A new client has logged to the server! :)");
...
function broadcast(data, socketToOmit) {
  ...
  wsServer.clients.forEach(connectSocket => {
    if(connectSocket.readyState === WebSocket.OPEN && connectSocket !== socketToOmit){
